...
weight <- select(weighttime, -Time)

#Let's rename a column name
#TASK: Write the code that renames 'weight' to 'ounces'
df_Shiyi <- df_Shiyi %>% rename(ounces = weight)
